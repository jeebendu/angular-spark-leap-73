    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white rounded-lg border">
          <Calendar
            mode="single"
            selected={appointmentObj?.slot?.date}
                      ...
                      {morningSlots.map((slot) => (
                        <Button
                          ...
                          className={`text-sm h-10 ${
                            appointmentObj?.slot?.startTime === slot.startTime ? "bg-primary text-white border-primary hover:bg-primary/90 hover:text-white" : ""
                          }`}
