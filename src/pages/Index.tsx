  ...
  return (
    <AppLayout>
      <div className="container px-4 py-6">
        ...
        >
          <div className="rounded-xl bg-white p-6 mb-6 md:p-8 overflow-hidden relative card-shadow">
            <div className="w-full">
              ...
              >
                <h1 className="text-2xl md:text-3xl font-bold mb-2">Find and Book the Best Doctors</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="border-none card-shadow">
              <CardContent className="p-6 flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-full sky-gradient flex items-center justify-center mb-3">
                  <Award className="h-6 w-6 text-white" />
                </div>
                <h3 className="font-medium mb-2">Top Specialists</h3>
                <p className="text-sm text-muted-foreground">Access to board-certified specialists with extensive experience</p>
              </CardContent>
            </Card>
            <Card className="border-none card-shadow">
              <CardContent className="p-6 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-muted-foreground">Book appointments anytime with our easy-to-use platform</p>
              </CardContent>
            </Card>
            <Card className="border-none card-shadow">
              <CardContent className="p-6 flex flex-col items-center text-center">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold">Top Rated Doctors</h2>
            <Button variant="link" className="text-primary">View All</Button>
          </div>
