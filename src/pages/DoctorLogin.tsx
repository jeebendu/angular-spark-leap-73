...
export default function DoctorLogin() {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Create authUser object with required fields for doctor
    ...
    try {
      ...
      if (response.status) {
        ...
        login(
          ...
          { name: "Doctor User", mobile: phoneNumber, userType: "doctor" },
          "doctor"
        );
      ...
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 to-sky-100">
        <div className="w-full max-w-md rounded-xl bg-white p-8 shadow-lg">
          <div className="mb-6 text-center">
            ...
            <p className="text-gray-600">Login to access your doctor dashboard</p>
          </div>
