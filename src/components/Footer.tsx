      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <h3 className="font-bold text-lg mb-4">ClinicHub</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/doctor-search" className="text-gray-600 hover:text-primary transition-colors">Find Doctors</Link>
              </li>
              <li>
                <Link to="/appointments" className="text-gray-600 hover:text-primary transition-colors">My Appointments</Link>
              </li>
              <li>
                <Link to="/tests" className="text-gray-600 hover:text-primary transition-colors">Book Tests</Link>
              </li>
              <li>
                <Link to="/reports" className="text-gray-600 hover:text-primary transition-colors">My Reports</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              ...
              />
              <Button className="sky-button rounded-l-none">
